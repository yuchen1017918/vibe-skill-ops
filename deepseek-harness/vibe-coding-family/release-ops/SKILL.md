---
name: release-ops
description: 发布与回滚一体化 skill（v1.3 合并自 release-management + rollback-backup）： SemVer版本 + CHANGELOG + tag + 发布检查清单 + 备份三件套 + 部署验证 + 回滚流程。 当用户说"发布"、"发版本"、"打tag"、"上线"、"部署"、"出问题了"、 "回滚"、"备份"、"恢复"时加载。 触发词：发布、发版本、打tag、上线、部署、回滚、备份、恢复。
