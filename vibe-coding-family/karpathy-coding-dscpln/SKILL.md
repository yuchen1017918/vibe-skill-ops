...
description: |
  Karpathy 编码纪律 overlay：Think Before Coding / Simplicity First / Surgical Changes /
  Goal-Driven Execution 四原则。当进行非平凡代码改动、bugfix、refactor、review 前自检、
  或担心过度设计/隐藏假设/diff 蔓延时加载。vibe-coding 迭代的刹车片。
version: 1.0.0
...
metadata:
  hermes:
    type: policy
    tags: [vibe-coding, coding-discipline, karpathy, refactor, review]
    related_skills: [vibe-coding-hub, vibe-coding, code-review]
---
