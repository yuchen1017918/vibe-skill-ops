...
name: dev-stack-hub
description: |
  全家桶 L2 目录 — 技术栈层。覆盖：编程语言、前端/UI、数据库、
  移动端、游戏引擎。当项目确定技术栈后，先加载本目录
  定位对应语言/框架的 L3 skill。
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [vibe-coding, hub, stack, language, frontend, database]
    related_skills: [vibe-coding-hub, python3, typescript, frontend-design, sql]
---
