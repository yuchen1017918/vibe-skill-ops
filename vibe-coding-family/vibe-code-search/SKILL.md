...
description: |
  代码语义搜索 skill：大项目 vibe-coding 时不用把全部代码塞进上下文，
...
metadata:
  hermes:
    type: tool
    tags: [vibe-coding, code-search, semantic, retrieval, mcp]
    related_skills: [vibe-coding-hub, vibe-coding, hermes-mcp-setup]
---
