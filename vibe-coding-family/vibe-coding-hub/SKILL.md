...
> 24 个自建 L3 全量标注：tool 8 个 / workflow 8 个 / policy 6 个 / meta 2 个（v1.3 合并 3 组净减 3；v1.2 安全线新增 code-security；v1.3 新增 open-code-review 审查引擎）。
...
## 🎯 触发词治理（v3.6 新增 — 30 个 skill 的信号仲裁）
